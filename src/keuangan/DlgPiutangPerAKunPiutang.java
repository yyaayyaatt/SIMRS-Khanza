...
public final class DlgPiutangPerAKunPiutang extends javax.swing.JDialog {
    ...
    public void tampil() {
        ...
        try {
            ...
            htmlContent.append(
                    "<tr class='head'>" + "<td valign='middle' bgcolor='#fafff5' align='center' width='27px'>No.</td>"
            ...
            try {
                ...
                while (rsakunbayar.next()) {
                    ...
                    kolom++;
                    htmlContent.append("<td valign='middle' bgcolor='#fafff5' align='center' width='130px'>"
